function pe = MPSK_NAKAGAMI(M)
% ========================================================================================================================
% BIT ERROR PROBABILITY OF M-PSK OVER NAKAGAMI FADING CHANNEL SUBJECTED TO DOUBLE GATED NOISE
...
title('BEP of M-PSK over Nakagami Fading Channel subjected to Double Gated Noise','FontSize',16)
